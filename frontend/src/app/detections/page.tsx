...
export default function DetectionsPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* ── STATUS BARS ROW ── */}
      <div className="flex flex-row items-center gap-4 text-xs sm:text-sm">
        {/* ── BACKEND STATUS ── */}
        ...
        <div className="flex items-center gap-1.5 font-medium text-slate-700">
          ...
          />
          <span>
            {isAgentActive ? "Monitoring Agent is online." : "Monitoring Agent is offline."}
          </span>
        </div>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-sm">
            <span className="flex items-center gap-1.5 text-[10px] sm:text-xs font-bold tracking-wider text-black">
              <svg className="h-3.5 w-3.5 sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              Total Known
            </span>
            <p className="mt-1.5 text-xl sm:text-2xl font-black text-black">{presenceData.total_known_persons}</p>
            <p className="mt-0.5 text-[10px] sm:text-xs text-black">Registered users seen</p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-sm">
            ...
            <p className="mt-1.5 text-xl sm:text-2xl font-black text-black">{presenceData.total_unknown_persons}</p>
            <p className="mt-0.5 text-[10px] sm:text-xs text-black">Unregistered logs</p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-sm">
            ...
            <p className="mt-1.5 text-xl sm:text-2xl font-black text-black tabular-nums">{formatTime(presenceData.known_time_present)}</p>
            <p className="mt-0.5 text-[10px] sm:text-xs text-black">Known cumulative time</p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-sm">
            ...
            <p className="mt-1.5 text-xl sm:text-2xl font-black text-black tabular-nums">{formatTime(presenceData.unknown_time_present)}</p>
            <p className="mt-0.5 text-[10px] sm:text-xs text-black">Unknown cumulative time</p>
          </div>
        </div>

        <div className="w-full">
          {/* ── REAL-TIME PRESENCE LOG HISTORY ── */}
          <div className="rounded-[2rem] border border-slate-200 bg-white/90 p-5 sm:p-6 shadow-lg">
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          {isSessionActive ? (
                            <span className="flex items-center gap-1 rounded-full bg-green-100 px-2 py-0.5 text-[9px] font-extrabold uppercase tracking-widest text-green-700 border border-green-200">
